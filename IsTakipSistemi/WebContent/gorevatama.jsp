...
<body>
	    ...
	    <article>
			...
			<h2>Görev Atama Sayfası</h2>
			
			<br>
			
			
					 <%
					 		int id = Integer.valueOf(request.getParameter("gorev"));
				...
				<fieldset>
					...
					<form action="gorevatama_kayit.jsp?id=<%=id%>" name="basitBirForm" method="post">
						...
						<p><label for="email">Sorumlu:</label>
					<select name="sorumlu" id="sorumlu">
				
					    <option value="" disabled="disabled" selected="selected">Please select a name</option>
					  
					    <%
					    	
					    	ArrayList<String> sorumlular = dbops.sorumluGetir();
					    	 for(int i = 0; i<sorumlular.size();i++){
					    			out.println("<option value="+"'"+sorumlular.get(i)+"'"+">");	
					    			out.println(sorumlular.get(i));	
					    			out.println("</option>");	
					    	 }
					    %>
						...
						<p><input type="submit" name="send" class="formbutton" value="Görev Ata" /></p>
					</form>
