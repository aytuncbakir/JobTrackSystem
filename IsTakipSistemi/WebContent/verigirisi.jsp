	    ...
	    <article>
			...
			<br>
				...
				<fieldset>
					...
					<legend>Görev Verileri</legend>
					<form action="gorevkayit.jsp" name="basitBirForm" method="post">
						<p><label for="name">Görev Adı:</label>
						<input type="text" name="gorevadi" id="gorevadi" value="" /><br /></p>		
						<p><label for="email">Firma:</label>
						<input type="text" name="firma" id="firma" value="" /><br /></p>
						<p><label for="name">Sorun:</label>
						<input type="text" name="sorun" id="sorun" value="" /><br /></p>		
						<p><label for="email">Ürün:</label>
						<input type="text" name="urun" id="urun" value="" /><br /></p>
						<p><label for="name">Problem:</label>
						<input type="text" name="problem" id="problem" value="" /><br /></p>		
						<p><input type="submit" name="send" class="formbutton" value="Save" /></p>
					</form>
